  ...
  return (
    <div className='flex flex-col justify-between items-center w-[340px]'>
      ...
      <div className="flex flex-row justify-center items-center gap-2.5 mt-[200px]">
        <div onClick={() => window.location.href='https://docs.google.com/spreadsheets/d/1-gCiIaM8YQPBwkh-kbkm1oGRb7nkdEmXcFC2kWnUeeg/edit?gid=0#gid=0'} className='bg-primary text-white w-[165px] border-none rounded-[10px] h-10 flex flex-row justify-center items-center gap-2.5 cursor-pointer'><span className='leading-[130%]'>Ткани</span> <img className='w-[18px] h-[18px]' src="/images/icons/buttonIcon1.svg" alt="" /></div>
